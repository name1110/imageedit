...
class ImageAiEditing4transActivity: AppCompatActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.ai_editing_image4trans)
        ...
        findViewById<Button>(R.id.btnprocess).setOnClickListener {
            if (ContextCompat.checkSelfPermission(
                ...
                performNetworkOperation4trans(backgroundImage) { processedBitmap ->
    ...
    private fun performNetworkOperation4trans(backgroundImage: Bitmap, callback: (Bitmap) -> Unit) {
        lifecycleScope.launch {
            try {
                ...
                val option = getSelectedstyle()
                val param = "option=$option&image=$imgParam"
                ...
                val accessToken = try {
                    ...
                    e.printStackTrace()
                    Toast.makeText(this@ImageAiEditing4transActivity, "Failed to get access token", Toast.LENGTH_SHORT).show()
                    return@launch
                }
                ...
                if (base64Image != null) {
                    ...
                    if (processedBitmap != null) {
                        ...
                        Toast.makeText(
                            this@ImageAiEditing4transActivity,
                ...
                e.printStackTrace()
                // 处理异常情况
                Toast.makeText(this@ImageAiEditing4transActivity, "网络操作失败", Toast.LENGTH_SHORT).show()
            }
        }
    }
