...
class ImageAiEditing4acgActivity  : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btnprocess).setOnClickListener {
            if (ContextCompat.checkSelfPermission(
                ...
                performNetworkOperation4acg(backgroundImage) { processedBitmap ->
    ...
    private fun performNetworkOperation4acg(backgroundImage: Bitmap, callback: (Bitmap) -> Unit) {
        lifecycleScope.launch {
            try {
                ...
                val accessToken = try {
                    ...
                    e.printStackTrace()
                    Toast.makeText(this@ImageAiEditing4acgActivity, "Failed to get access token", Toast.LENGTH_SHORT).show()
                    return@launch
                }
                ...
                if (base64Image != null) {
                    ...
                    if (processedBitmap != null) {
                        ...
                        Toast.makeText(
                            this@ImageAiEditing4acgActivity,
                ...
                e.printStackTrace()
                // 处理异常情况
                Toast.makeText(this@ImageAiEditing4acgActivity, "网络操作失败", Toast.LENGTH_SHORT).show()
            }
        }
    }
